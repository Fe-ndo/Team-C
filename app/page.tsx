      ...
      <section>
        <div className='flex pt-16 justify-between'>
          {listFeatures.map((feature, index) => {
            return (
              <FeatureCard key={index} featureTitle={feature.featureTitle} featureDesc={feature.featureDesc} />
            )
          })}
        </div>
      </section>
...
const listFeatures: CardProps[]= [
  ...
  },
  {
    ...
    featureDesc:"We host a comprehensive database of workouts with all the info you need"
  },
  {
